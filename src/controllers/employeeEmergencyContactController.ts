...
import { employeeEmergencyContactService } from '../services/employeeEmergencyContact.service';
...
export const list = async (req: Request, res: Response) => {
  ...
  const records = await employeeEmergencyContactService.list(userId, role, target.id);
  ok(res, records, 'Emergency contact records fetched');
};
