...
export const submit = async (req: Request, res: Response) => {
  ...
  const result = await workLogService.submitEntries(req.employee.userId, entries);
...
export const listMine = async (req: Request, res: Response) => {
  ...
  const logs = await workLogService.listMine(req.employee.userId, { from, to });
...
export const bulkUpload = async (req: Request, res: Response) => {
  ...
  const result = await workLogService.bulkUpload(req.employee.userId, req.file.path);
