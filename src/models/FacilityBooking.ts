...
export class FacilityBookingModel {
  static async getAll(filters?: {
    ...
    let query = `
      ...
      JOIN users u ON fb.employee_id = u.employee_id
      WHERE 1=1
    `;
    const params: any[] = [];
  ...
  static async create(
    ...
    const result = await pool.query(
      "INSERT INTO facility_bookings (facility_id, employee_id, start_time, end_time, purpose, status) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id",
      params,
    );
