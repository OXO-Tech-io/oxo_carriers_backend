...
import * as employeeDependentController from '../controllers/employeeDependentController';
import { authenticate } from '../middleware/auth';
import { validate } from '../middleware/validate';
import { asyncHandler } from '../utils/asyncHandler';
import { employeeIdParamSchema } from '../validators/employeeEducation.validator';

// Mounted at /api/employees/:employeeId/dependents - mergeParams so the
...
router.get('/', validate(employeeIdParamSchema, 'params'), asyncHandler(employeeDependentController.list));
